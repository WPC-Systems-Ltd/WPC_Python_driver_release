...
This example demonstrates how to write DIO loopback in pins from EthanL.
...
def main():
    ...
    try:
        ...
        err = dev.DO_closePins(port, [0,1,2,3,4])
        print("DO_closePins:", err)

        ## Close pin5, pin6 and pin7 with digital input
        err = dev.DI_closePins(port, [5,6,7])
