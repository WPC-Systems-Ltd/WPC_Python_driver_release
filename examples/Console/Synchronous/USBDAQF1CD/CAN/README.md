# CAN (Synchronous Mode)
> **Note**
> Ensure you are connected to the correct IP address or serial number.

## Overview

This project demonstrates how to use the WPC Python driver to handle Controller Area Network (CAN) communications using synchronous mode.
...
- You need predictable timing for data transfer
