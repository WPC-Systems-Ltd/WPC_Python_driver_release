...
In order to run this example, you should get STEM product, which contains I2C master interface.

Then, we take `STEM` for example and use 24C08C as I2C slave, which connect directly to `STEM`.
