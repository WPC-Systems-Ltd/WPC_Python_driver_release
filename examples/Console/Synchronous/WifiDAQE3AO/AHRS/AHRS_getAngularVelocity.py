'''
AHRS - AHRS_getAngularVelocity.py with synchronous mode.

This example demonstrates the process of getting AHRS three axis angular velocity data from WifiDAQE3AO.
...
def main():
    ...
    try:
        ...
        while True:
            data = dev.AHRS_getAngularVelocity(port, timeout)
            print(data)
