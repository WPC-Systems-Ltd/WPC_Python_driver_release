# Motion (Synchronous Mode)
> **Note**
> Ensure you are connected to the correct IP address or serial number.

## Overview

This project demonstrates how to use the WPC Python driver to handle motion control operations using synchronous mode.
...
- You're working with a single axis
- You prefer traditional procedural programming style
- You need predictable timing for motion control
