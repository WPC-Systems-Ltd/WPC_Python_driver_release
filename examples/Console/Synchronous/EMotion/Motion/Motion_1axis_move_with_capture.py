...
def main():
    ...
    try:
        ...
        ## Motion configure
        err = dev.Motion_cfgCapture(port, axis, rising_edge, capture_logical_position)
        print("Motion_cfgCapture:", err)

        err = dev.Motion_enableCapture(port, axis, int(True))
        ...
        while move_status == 0:
            ...
            capture_points = dev.Motion_readCapturePoint(port, axis)
