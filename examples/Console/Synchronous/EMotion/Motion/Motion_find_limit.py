'''
Motion - Motion_find_limit.py with synchronous mode.
...
def main():
    ...
    try:
        ...
        err = dev.Motion_cfgFindRef(port, axis, find_limit, dir_reverse, search_velo=10000, search_accle=10000, approach_velo_percent=20, en_reset_posi=0, offset_posi=1500, timeout=timeout)
