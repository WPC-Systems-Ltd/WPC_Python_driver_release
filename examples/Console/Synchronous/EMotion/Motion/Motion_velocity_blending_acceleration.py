...
def main():
    ...
    try:
        ...
        err = dev.Motion_cfgAxisMove(port, axis, velocity_mode, velocity = 3000)
        ...
        new_accel = 100
        new_decel = 100
        err = dev.Motion_overrideAxisVelocity(port, axis, new_velo)
        print("Motion_overrideAxisVelocity:", err)

        ## Motion override acceleration
        err = dev.Motion_overrideAxisAccel(port, axis, new_accel, new_decel)
