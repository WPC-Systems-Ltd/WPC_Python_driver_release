...
def main():
    ...
    try:
        ...
        ## Motion configure
        err = dev.Motion_cfg3AxisLinearInterpo(port, axis1, dest_posi1, axis2, dest_posi2, axis3, dest_posi3, speed = 2000)
        ...
        move_status = 0; 
        while move_status == 0:
            axis1_move_status = dev.Motion_getMoveStatus(port, axis1)
            axis2_move_status = dev.Motion_getMoveStatus(port, axis2)
            axis3_move_status = dev.Motion_getMoveStatus(port, axis3)
