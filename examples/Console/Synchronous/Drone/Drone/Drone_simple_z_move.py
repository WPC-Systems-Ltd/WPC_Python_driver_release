'''
Drone - Drone_simple_z_move.py with synchronous mode.
...
def main():
    ...
    try:
        ...
        ## Z move with NED frame
        err = dev.Drone_moveNedRelZ(z_move, velocity, timeout)
        print(f"Drone_moveNedRelZ, status: {err}")
