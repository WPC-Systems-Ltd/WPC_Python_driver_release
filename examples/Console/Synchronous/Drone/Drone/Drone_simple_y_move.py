'''
Drone - Drone_simple_y_move.py with synchronous mode.
...
def main():
    ...
    try:
        ...
        ## Y move with vehicle frame
        err = dev.Drone_moveVehicleRelY(y_move, velocity, timeout)
        print(f"Drone_moveVehicleRelY, status: {err}")
