...
This example demonstrates how to get hardware information from USBDAQF1AOD.
...
def main():
    ...
    try:
        ...
        print(f'Serial number = ' + dev.Sys_getSerialNumber())
        print(f'RTC data time = ' + dev.Sys_getRTC())
