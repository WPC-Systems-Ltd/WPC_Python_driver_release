'''
AHRS - AHRS_getAcceleration.py with asynchronous mode.

This example demonstrates the process of getting AHRS three axis acceleration data from WifiDAQE3AO.
...
async def main():
    ...
    try:
        ...
        while True:
            ahrs_list = await dev.AHRS_getAcceleration_async(port)
            print(ahrs_list)
