...
async def main():
    ...
    try:
        ...
        print(f"startSingleAxisMove_async in axis{axis1}, status: {err}")
        ...
        print(f"startSingleAxisMove_async in axis{axis2}, status: {err}")
        ...
        print(f"startSingleAxisMove_async in axis{axis3}, status: {err}")
        ...
        for i in [axis1, axis2, axis3]:
            ...
            print(f"ServoOff_async in axis{i}, status: {err}")
