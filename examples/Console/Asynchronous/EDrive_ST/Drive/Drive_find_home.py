'''
Drive - Drive_find_home.py with asynchronous mode.
...
async def main():
    ...
    try:
        ...
        err = await dev.Motion_startFindHome_async(port, searching_speed, approaching_speed, acceleration, search_direction, approach_direction, offset, reset_position)
