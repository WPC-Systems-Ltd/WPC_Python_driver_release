...
To run this example, you will need a EthanEXD product, which contains DIO function.
...
A return value of 0 indicates successful communication with the EthanEXD.
