...
In order to run this example, you should get EthanEXD product, which contains DIO function.

Then, we take `EthanEXD` for example.

### EthanEXD

<img src="https://github.com/WPC-Systems-Ltd/WPC_Python_driver_release/blob/main/Reference/Pinouts/pinout-EthanEXD.JPG" alt="drawing" width="600"/>
...
If function return value is 0, it represents communication with `EthanEXD` successfully.
