...
In order to run this example, you should get EthanEX_D product, which contains DIO function.

Then, we take `EthanEX_D` for example.

### EthanEX_D

<img src="https://github.com/WPC-Systems-Ltd/WPC_Python_driver_release/blob/main/Reference/Pinouts/pinout-EthanEX_D.JPG" alt="drawing" width="600"/>
...
If function return value is 0, it represents communication with `EthanEX_D` successfully.
