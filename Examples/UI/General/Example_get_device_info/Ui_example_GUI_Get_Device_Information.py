...
# Form implementation generated from reading ui file 'd:\Chunglee_WPC\Python_Driver_GUI_Example\UIexample_get_device_info\example_GUI_Get_Device_Information.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_trademark.setPixmap(QtGui.QPixmap("d:\\Chunglee_WPC\\Python_Driver_GUI_Example\\UIexample_get_device_info\\../Material/WPC_trademark.jpg"))
        ...
        self.lb_declare.setGeometry(QtCore.QRect(140, 80, 601, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.groupBox_connection.setGeometry(QtCore.QRect(230, 120, 381, 81))
        font = QtGui.QFont()
        ...
        self.btn_connect.setGeometry(QtCore.QRect(180, 30, 81, 31))
        font = QtGui.QFont()
...
"}")
        ...
        self.btn_disconnect.setGeometry(QtCore.QRect(270, 30, 101, 31))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        font.setBold(True)
...
"}")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(21, 21, 86, 341))
        ...
        self.lb_mac_2 = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.lb_mac_2.setFont(font)
        self.lb_mac_2.setObjectName("lb_mac_2")
        self.verticalLayout.addWidget(self.lb_mac_2)
        self.lb_mac_3 = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.lb_mac_3.setFont(font)
        self.lb_mac_3.setObjectName("lb_mac_3")
        self.verticalLayout.addWidget(self.lb_mac_3)
        self.lb_mac_4 = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.lb_mac_4.setFont(font)
        self.lb_mac_4.setObjectName("lb_mac_4")
        self.verticalLayout.addWidget(self.lb_mac_4)
        ...
        self.btn_deviceInfo.setGeometry(QtCore.QRect(630, 230, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
...
"}")
        ...
        self.groupBox_connection_2.setGeometry(QtCore.QRect(140, 620, 591, 101))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.groupBox_connection_2.setFont(font)
        self.groupBox_connection_2.setAutoFillBackground(True)
        ...
        self.lb_err = QtWidgets.QLabel(self.groupBox_connection_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_mac_2.setText(_translate("MainWindow", "Model"))
        self.lb_mac_3.setText(_translate("MainWindow", "Firmware ver."))
        self.lb_mac_4.setText(_translate("MainWindow", "RTC"))
        self.btn_deviceInfo.setText(_translate("MainWindow", "Get Device Info"))
        self.groupBox_connection_2.setTitle(_translate("MainWindow", "Error Messages"))
